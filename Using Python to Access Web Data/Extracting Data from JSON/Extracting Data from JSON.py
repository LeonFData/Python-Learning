...
Actual data: http://python-data.dr-chuck.net/comments_370783.json (Sum ends with 20)  <<<-------------------------
...
url = 'http://python-data.dr-chuck.net/comments_370783.json'
page = urllib.request.urlopen(url)
data = page.read().decode('utf8')
j_parsed = json.loads(data)

comments = j_parsed['comments']
