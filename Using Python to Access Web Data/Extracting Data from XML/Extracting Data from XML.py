...
Actual data: http://python-data.dr-chuck.net/comments_370779.xml (Sum ends with 4)
...
The closest sample code that shows how to parse XML is geoxml.py. But since the nesting of the elements in our data is different than the data we are parsing in that samplecode you will have to make real changes to the code.
...
url = 'http://python-data.dr-chuck.net/comments_370779.xml'
data = urllib.request.urlopen(url).read()   # into a string
